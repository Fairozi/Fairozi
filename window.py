...
def kimochi():
	rr = random.randint
	rc = random.choice
	chrome_ver = f"{str(rr(100,110))}.0.{str(rr(1000,9000))}.{str(rr(100,900))}"
	haha1 = f"Mozilla/ 5.0(Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, Like Gecko) Chrome/93.0.4577.82 Safari/537.36 Edg/93.0.961.52"
	haha2 = f"Mozilla/5.0 (Windows NT 10.0; Win32; x86) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome_ver} Mobile Safari/537.36"
	haha3 = f"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_5) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/{str(rr(12,22))}.0 Chrome/{chrome_ver} Mobile Safari/537.36"
	haha4 = f"Mozilla/5.0 (Windows NT 10.0{str(rr(8,12))}; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{chrome_ver} Mobile Safari/537.36"
	haha5 = f"Mozilla/5.0 (Linux; Android 6.0.1; SAMSUNG SM-G532G Build/MMB29T) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/4.2 Chrome/44.0.2403.133 Mobile Safari/537.36"
	uague = rc([haha1,haha2,haha3,haha4,haha5])
...
for t in range(10000):
	...
	zax1=f'Mozilla/5.0 (Linux; Android 10; K) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/{z}.0.0.0 Mobile Safari/537.36'
	zax2=f'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko; compatible; Linespider/1.1; +https://lin.ee/4dwXkTH) Chrome/108.0.0.0 Safari/537.36'
	zax3=f'NokiaX2-02/2.0 (11.79) Profile/MIDP-2.1 Configuration/CLDC-1.1 Mozilla/4.0 (compatible; MSIE 8.0; Windows NT 6.1; Trident/4.0; SLCC2;.NET CLR 2.0.50727; .NET CLR 3.5.30729; .NET CLR 3.0.30729; Media Center PC 6.0; InfoPath.2) UCBrowser8.4.0.159/70/352'
	zax4=f'Mozilla/5.0 (Windows; U; Windows NT 5.2; en-US) AppleWebKit/534.31 (KHTML, like Gecko) Chrome/17.0.558.0 Safari/534.31 UCBrowser/3.4.3.532'
	uaku2 = random.choice([zax1,zax2,zax3,zax4])
	ugen.append(uaku2)
def uaku():
	try:
